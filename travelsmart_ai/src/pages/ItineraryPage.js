...
function ItineraryPage() {
  ...
  const AMA_API_KEY = 'I3Qf2ShydSGU7hDgLDG3IAl3hHO5QJwt' //process.env.REACT_APP_AMADEUS_API_KEY || 'I3Qf2ShydSGU7hDgLDG3IAl3hHO5QJwt'
  const AMA_API_SECRET = '0FMhmIHl7JHsbFpy'//process.env.REACT_APP_AMADEUS_API_SECRET || '0FMhmIHl7JHsbFpy'
  ...
  return (
    <div className="container" style={{ maxWidth: 540, marginTop: 110 }}>
      ...
      <button
        ...
        style={{
          marginTop: 18, marginBottom: 8, width: "100%",
      ...
      {(flightsError && showFlights) && <div style={{ color: "var(--danger)", margin: "10px 0", fontWeight: 600 }}>{flightsError}</div>}
            ...
            return (
              <div
                ...
                style={{
                  ...
                  padding: "13px 15px",
                  boxShadow: "0 1px 8px 0 #D6E6F266",
                  flex: "1 1 260px"
                }}
              >
                <div style={{fontWeight: 600, marginBottom: 7, color: "var(--accent)"}}>
                  {info.from} <span style={{fontWeight:400}}>&rarr;</span> {info.to}
                </div>
                <div style={{fontWeight: 500}}>
                  Airline:{" "}
                  <span style={{color: "var(--secondary-text)"}}>{info.airline}</span>
                </div>
                ...
                <div style={{marginTop: 5, fontWeight: 600, color: "var(--heading)"}}>
      ...
      {itineraryByDay.length > 0 && (
        <div
          style={{
            ...
            borderRadius: 10,
            padding: 22,
            boxShadow: "0 1px 8px #D6E6F233"
          }}
        >
          <div className="subtitle" style={{ marginBottom: 10, color: "var(--accent)" }}>
          ...
          {itineraryByDay.map(({ day, activities }) => (
            ...
            >
              <div style={{ fontWeight: 600, fontSize: "1.13rem", marginBottom: 4, color: "var(--heading)" }}>
                {day}
              </div>
              <ul style={{ margin: "0 0 0 10px", padding: 0, color: "var(--text-color)" }}>
